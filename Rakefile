...
ssh_user       = "maxalc@douglas.dreamhost.com"
ssh_port       = "22"
document_root  = "maxarturoas.com/"
rsync_delete   = true
...
task :rsync do
  ...
  ok_failed system("rsync --chmod=u=rwx,g=rx,o=rx -avze 'ssh -p #{ssh_port}' #{exclude} #{rsync_args} #{"--delete" unless rsync_delete == false} #{public_dir}/ #{ssh_user}:#{document_root}")
end
